...
SECRET_KEY = 'django-insecure-bon32fk-fkg9l!odw-g@c-*sc(t#w^@fvj$c*$w)-s9q6r1!4#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['10.1.15.132', 'localhost', '127.0.0.1','192.168.14.59','192.168.6.59','0.0.0.0']
...
ROOT_URLCONF = 'CoopRepo.urls'

AUTHENTICATION_BACKENDS = [
    'file_management.custom_auth_backend.EmailBackend',
...
WSGI_APPLICATION = 'CoopRepo.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'file_management' / 'static',
]
